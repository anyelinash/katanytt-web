    ...
    <div className="container d-flex justify-content-center align-items-center min-vh-100">
      <div className="row border rounded-5 p-3 bg-white shadow box-area"  style={{ maxWidth: '1000px', height: '500px' }}>
        <div className="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style={{ background: '#89bbcb' }}>
          ...
          <img src={loginImage} className="img-fluid" style={{ width: '350px' }} alt="Entrena" />
          </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="input-group mb-5 d-flex justify-content-between">
              ...
              <div className="forgot">
                <small>
                  <a href="/" className="link-dark">¿Olvidaste tu contraseña?</a>
                </small>
              </div>
            </div>
            <div className="input-group mb-3">
              <button className="btn btn-lg btn-dark w-100 fs-6" onClick={handleLogin}>Login</button>
            </div>
            <div className="row">
              <small>
                No tienes una cuenta &nbsp; &nbsp;
                <a href="/signup" className="link-secondary">Crear Cuenta</a>
              </small>
            </div>
          </div>
        </div>
